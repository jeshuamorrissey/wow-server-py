    ...
    'data' / If(
        ...
        Struct(
            ...
            'times' / Switch(
                ...
                {
                    enums.BattlegroundStatus.WAIT_QUEUE: Struct(
                        'avg_wait_time_ms' / Int32ul,
                        'queue_time_ms' / Int32ul,
                    ),
                    enums.BattlegroundStatus.WAIT_JOIN: Struct('remove_from_queue_ms' / Int32ul),
                    enums.BattlegroundStatus.IN_PROGRESS: Struct(
