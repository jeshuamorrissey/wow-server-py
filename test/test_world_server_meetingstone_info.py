...
def test_handle_meetingstone_info(mocker, fake_db):
    ...
    client_pkt = packet.ClientMeetingstoneInfo.parse(packet.ClientMeetingstoneInfo.build(dict()))
    ...
    response_pkt = meetingstone_setqueue.ServerMeetingstoneSetqueue.parse(response_bytes)
